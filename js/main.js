...
jQuery(document).ready(function($) {
	...
	$('#counter-1').animateNumber({ number: 10000 }, 2000 );
	$('#counter-2').animateNumber({ number: 3 }, 2000 );
	$('#counter-3').animateNumber({ number: 999 }, 2000 );
	},{accX: 0, accY: -200});
});


	$('#expand-counters').appear(function() {
	$('#expand-counter-1').animateNumber({ number: 98 }, 3000 );
	$('#expand-counter-2').animateNumber({ number: 72 }, 3000 );
	$('#expand-counter-3').animateNumber({ number: 84 }, 3000 );
	$('#expand-counter-4').animateNumber({ number: 67 }, 3000 );
	},{accX: 0, accY: -200});
